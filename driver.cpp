...
int main(){
    ...
    fs::remove_all(".minature_vc");
    fs::create_directory(".minature_vc"); 
    minature_vc repo;
   ...
   cin >> num;
    ...
    switch(num){
        ...
        case 3:
        {
            ...
            repo.traverseSLLAndCheckminature_vc(lastDouble); //check to see if files exist in minature_vc and checks to see if they have been changed
